...
class AlasGUI(Frame):
    ...
    def dev_update(self) -> None:
        ...
        def u(state):
            ...
            clear("updater_btn")
            if state == 0:
                put_loading("border", "secondary", "updater_loading")
    ...
    def dev_remote(self) -> None:
        ...
        def u(state):
            ...
            if state in (1, 2):
                ...
                put_loading("border", "secondary", "remote_loading")
                if (
    ...
    def show(self) -> None:
        ...
        with use_scope("content"):
            ...
            put_text("I18N 暂时不维护").style("text-align: center")
            ...
            put_markdown(
                """
            NCE is a free open source software, if you paid for Alas from any channel, please refund.
            NCE 是一款免费开源软件，如果你在任何渠道付费购买了 NCE，请退款。
            Project repository 项目地址：`https://github.com/QiE2035/NeuralCloudEnhncer`
            """
            ).style("text-align: center")
    ...
    def run(self) -> None:
        # setup gui
        set_env(title="NCE", output_animation=False)
